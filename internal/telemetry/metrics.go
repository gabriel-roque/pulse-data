...
func NewMetrics(reg prometheus.Registerer) *Metrics {
	m := &Metrics{
		...
		EventsReceived:      prometheus.NewCounterVec(prometheus.CounterOpts{Name: "pulse_events_received_total", Help: "Events accepted by validation."}, nil),
		...
		EventsDuplicate:     prometheus.NewCounterVec(prometheus.CounterOpts{Name: "pulse_events_duplicate_total", Help: "Duplicate events."}, nil),
		RateLimitRejected:   prometheus.NewCounterVec(prometheus.CounterOpts{Name: "pulse_rate_limit_rejected_total", Help: "Rate limited requests."}, nil),
		...
		WebhookRetry:        prometheus.NewCounterVec(prometheus.CounterOpts{Name: "pulse_webhook_retry_total", Help: "Webhook retries."}, nil),
		WebhookDLQ:          prometheus.NewCounterVec(prometheus.CounterOpts{Name: "pulse_webhook_dlq_total", Help: "Webhook deliveries moved to DLQ."}, nil),
